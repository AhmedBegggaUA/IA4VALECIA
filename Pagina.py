...
SUPERA COVID-19 Santander-CRUE (CD4COVID19 2020–2021), Fundación BBVA for SARS-CoV-2 research (IA4COVID19 2020-2022) and the Valencian Government.''')
    ...
    if selected == "Predictions":
        ...
        with cols[0]:
            ...
            months_list_death = ["January","February","March","April","May","June","July","Agost","September","October","November","December"]
            months_dates = ["2020-12-28","2021-01-31","2021-01-31","2021-02-28","2021-02-28","2021-03-31","2021-03-31","2021-04-30",
                            "2021-04-30","2021-05-31","2021-05-31","2021-06-30","2021-06-30","2021-07-31"]
            months_list_short_death = ["2021_1","2021_2","2021_3","2021_4","2021_5","2021_6","2021_7","2021_8","2021_9","2021_10","2021_11","2021_12"]
            # TODO: Estoy aqui
            month_death = st.selectbox('Choose a month in 2021  ', months_list_death)
            month_death = months_list_short_death[months_list_death.index(month_death)]
